...
{
    class EpicRandomBattleLoadingSwfWorker : BaseSwfWorker
    {
        public EpicRandomBattleLoadingSwfWorker(Options options) : base(options)
        {
        }

        public override string SwfName { get; set; } = "epicRandomBattleLoading.swf";
