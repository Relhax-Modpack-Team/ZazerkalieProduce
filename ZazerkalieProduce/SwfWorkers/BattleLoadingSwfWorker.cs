...
{
    class BattleLoadingSwfWorker : BaseSwfWorker
    {
        public BattleLoadingSwfWorker(Options options) : base(options)
        {
        }

        public override string SwfName { get; set; } = "battleloading.swf";
